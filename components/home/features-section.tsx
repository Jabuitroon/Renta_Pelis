...
function FeatureCard({ feature }: { feature: FeatureItem }) {
  return (
    <div className="flex flex-col items-center text-center">
      {/* Circular image */}
      <div className="relative h-52 w-52 overflow-hidden rounded-full ring-2 ring-border/30 md:h-60 md:w-60">
        <Image
          src={feature.image}
          alt={feature.title}
          fill
      ...
      {/* Title */}
      <h3 className="mt-6 text-xl font-bold italic text-foreground md:text-2xl">
        {feature.title}
      </h3>
      {/* Description */}
