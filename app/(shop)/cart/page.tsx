...
export default function CartPage() {
  ...
  return (
    <main className='flex h-full mx-auto w-full bg-blue-500 font-sans dark:bg-gray-900'>
          ...
          <CardItem key={movie.imdbID} movie={movie} />
            ...
            <div>
              <h1 className='text-2xl font-bold tracking-tight text-foreground sm:text-3xl'>
                Tu Carrito de Producciones
              </h1>
              <p className='text-muted-foreground'>
                {cartItems.length}{' '}
                {cartItems.length === 1 ? 'película' : 'películas'} listas para
                tí
              </p>
            </div>
          </div>
                    ...
                    <CardContent className='p-0'>
                      ...
                      <div className='flex items-center gap-2 border-t border-border bg-secondary/30 px-4 py-2'>
                        ...
                        <span className='text-xs uppercase tracking-wider text-muted-foreground'>
                          Escena {index + 1} de {cartItems.length}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
